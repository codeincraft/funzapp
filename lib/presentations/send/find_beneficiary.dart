        ...
        body:  Container(
          ...
          child: Column(children: [
            Row(
              ...
              children: [
                Text('Frequent Beneficiaries', style: get12TextStyle(
                  fontSize: 13,
                  color: ColorManager.ktext,
                ),),
                Text('Find Beneficiary', style: get17TextStyle(
                  fontSize: 13,
                ),)
              ],
            ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      FittedBox(
                        child: Text('Osewa Daniel', style: get12TextStyle(
                  ...
                  child: Column(
                    ...
                    children: [
                      CircleAvatar(
                       ...
                       FittedBox(
                         child: Text('Akimi Jude', style: get12TextStyle(
                          fontWeight: FontWeight.w500,
                          fontSize: 10
                                               ),),
                       )
                  ...
                  child: Column(
                    ...
                    children: [
                      CircleAvatar(
                       ...
                       FittedBox(
                         child: Text('Rachael Uyo', style: get12TextStyle(
                          fontWeight: FontWeight.w500,
                          fontSize: 10
                                               ),),
                       )
                  ...
                  child: Column(
                    ...
                    children: [
                      CircleAvatar(
                       ...
                       FittedBox(
                         child: Text('Thelma Ade', style: get12TextStyle(
                          fontWeight: FontWeight.w500,
                          fontSize: 10
                                               ),),
                       )
