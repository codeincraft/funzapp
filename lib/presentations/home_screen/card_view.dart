                        ...
                        child: Row(
                          children: [
                            CircleAvatar(
                              radius: 13,
                              backgroundImage:
                                  AssetImage(Assets.images.nigeria.path),
                            ),
                            // Gap(5),
                            Spacer(),
                            Text(
                               ...
                               isVisible ? Row(
                                ...
                                IconButton(
                                  icon: isVisible
                                      ? Image(
                                          image: AssetImage(
                                              Assets.images.visibility.path)) : Icon(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: Container(
                            child: Row(
                              children: [
                                Image(image: AssetImage(Assets.images.topUp.path),
                                height: 20,),
                                Gap(05),
                                Text('Top Up', style: get28TextStyle(
                                  fontSize: 15,
                                  color: ColorManager.kbackground
                                ),)
                              ],
                          ...
                          child: Container(
                            child: Row(
                              children: [
                                ...
                                height: 20,),
                                Gap(05),
                                Text('Swap', style: get28TextStyle(
                                  fontSize: 15,
                                  color: ColorManager.kbackground,
                                ),)
                              ],
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            child: Row(
                              children: [
                                Image(image: AssetImage(Assets.images.more.path),
                                height: 20,),
                                Gap(05),
                                Text('More', style: get28TextStyle(
                                  fontSize: 17,
                                  color: ColorManager.kbackground
                                ),)
                              ],
